...
def find_centroid(cluster):
    ...
    # BEGIN Question 5
    return [mean(l) for l in zip(*[restaurant_location(restaurant) for restaurant in cluster])]
    # END Question 5
...
def k_means(restaurants, k, max_updates=100):
    ...
    while old_centroids != centroids and n < max_updates:
        ...
        # BEGIN Question 6
        centroids = [find_centroid(l) for l in group_by_centroid(restaurants,old_centroids)]
        # END Question 6
        n += 1
    return centroids
...
def best_predictor(user, restaurants, feature_fns):
    ...
    # BEGIN Question 8
    predicted = [find_predictor(user,reviewed, feature_fn) for feature_fn in feature_fns]
